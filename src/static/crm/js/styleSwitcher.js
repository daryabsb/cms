...
(function ($) {
    ...
    versionSelect.on('change', function () {
        ...
        /* if(this.value === 'dark'){
            ...
            jQuery(".nav-header .logo-compact").attr("src", ""/static/crm/images//logo-text-white.png");
            jQuery(".nav-header .brand-title").attr("src", ""/static/crm/images//logo-text-white.png");
            ...
            jQuery(".nav-header .logo-compact").attr("src", ""/static/crm/images//logo-text.png");
            jQuery(".nav-header .brand-title").attr("src", ""/static/crm/images//logo-text.png");
