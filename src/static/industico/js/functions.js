...
/*------------------------------------------------------------------------------*/ 
	...
	jQuery('#site-header-menu #site-navigation div.nav-menu > ul > li:has(ul), .prt-mmmenu-override-yes #site-header-menu #site-navigation .mega-menu-wrap > ul > li:has(ul)').append("<span class='righticon'><i class='prt-industico-icon-angle-down'></i></span>");	
...
/*------------------------------------------------------------------------------*/
	jQuery('.righticon').on('click', function() {
		if(jQuery(this).siblings('.sub-menu, .children, .mega-sub-menu').hasClass('open')){
			...
			jQuery( 'i', jQuery(this) ).removeClass('prt-industico-icon-angle-up').addClass('prt-industico-icon-angle-down');
		} else {
			jQuery(this).siblings('.sub-menu, .children, .mega-sub-menu').addClass('open');			
			jQuery( 'i', jQuery(this) ).removeClass('prt-industico-icon-angle-down').addClass('prt-industico-icon-angle-up');
		}
		return false;
 	});
...
var preyantechnosys_coverimgbox = function() {
	...
	jQuery('.tm_coverimgbox_wrapper .container').each(function(){
		var parentDiv = jQuery(this);

				jQuery('.tm_coverimgbox_wrapper .container .tm_coverbox_contents').hover(function () {
					jQuery('.tm_coverimgbox_wrapper .container .tm_coverbox_img').removeClass('active');
