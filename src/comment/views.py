...
from src.comment.forms import BlogCommentForm
from src.pages.models import Page
from django.http import JsonResponse
from django.core.paginator import Paginator
from src.core import utils
from src.menu.menu_config import ScreenOption
...
def cms_comment_list(request):
    ...
    if request.method == "POST":
        ...
        if filter_comment_name or filter_comment_email or filter_comment_status:
            ...
            comment_list = utils.data_filter_comment(
                filter_comment_form_data, Comment)
        ...
        if 'comment_filter_data' in list(request.session.keys()) and 'page' in list(request.GET.keys()):
            ...
            filter_comment_form_data = request.session.get(
                'comment_filter_data')
        else:
